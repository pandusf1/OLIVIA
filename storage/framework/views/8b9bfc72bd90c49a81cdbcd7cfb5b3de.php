...
<main class="max-w-6xl mx-auto px-6 py-10">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?php echo e(route('partner.index')); ?>" class="inline-flex items-center gap-2 text-sm font-bold text-gray-600 hover:text-gray-900 transition">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        ...
        <div>
            <a href="<?php echo e(route('chat.messages', ['partnerId' => $client->id])); ?>" class="inline-flex items-center gap-2 bg-gray-950 hover:bg-black text-white font-bold px-6 py-3 rounded-xl transition shadow-sm text-sm">
...
<?php /**PATH D:\CODING\olivia_final\resources\views/pages/partner/client_details.blade.php ENDPATH**/ ?>