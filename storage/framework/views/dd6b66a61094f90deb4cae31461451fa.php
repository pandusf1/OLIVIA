        ...
        <div class="space-y-4">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    ...
                    <a href="/tracking/<?php echo e($report->id); ?>" class="text-red-700 hover:text-red-800 text-xs font-semibold transition">Lihat Laporan →</a>
                </div>
                <div class="divide-y divide-gray-50">
                    ...
                    <div class="flex items-center justify-between px-5 py-3">
                        ...
                        <a href="<?php echo e(str_starts_with($ev->file_url, 'data:') ? $ev->file_url : url('/evidences/view/' . basename($ev->file_url))); ?>" target="_blank" class="text-red-700 hover:text-red-800 text-xs font-semibold transition">Buka →</a>
                    </div>
