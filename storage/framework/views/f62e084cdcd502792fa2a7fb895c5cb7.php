...
<head>
    ...
    <title>Savora — Riwayat Chat</title>
        ...
        <?php if($threads->count() > 0): ?>
            <div class="space-y-3">
                <?php $__currentLoopData = $threads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('chat.start', ['partnerId' => $t->partner_id])); ?>" class="block bg-white border border-gray-200 rounded-2xl p-4 hover:bg-gray-50 transition">
                        <div class="flex items-center justify-between gap-3">
                            <div class="min-w-0">
                                <p class="font-bold text-gray-900 truncate"><?php echo e($t->partner?->partner_name ?? 'Partner'); ?></p>
                                <p class="text-xs text-gray-400 mt-1"><?php echo e($t->partner?->partner_type ?? ''); ?> • <?php echo e($t->last_message_at?->format('d M Y, H:i') ?? 'Belum ada pesan'); ?></p>
                            </div>
...
<?php /**PATH D:\CODING\olivia_final\resources\views/pages/user/chat_threads.blade.php ENDPATH**/ ?>