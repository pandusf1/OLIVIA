...
<?php endif; ?>
        ...
        <div>
            <div class="flex justify-between items-center mb-1.5">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-gray-400 hover:text-gray-600 transition">Lupa?</a>
                <?php endif; ?>
            </div>
            <div class="relative">
...
<?php endif; ?>
        ...
        <p class="text-center text-gray-400 text-sm pt-1">
            Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-gray-900 font-semibold hover:text-red-700 transition">Daftar</a>
        </p>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\CODING\olivia_final\resources\views\auth\login.blade.php ENDPATH**/ ?>