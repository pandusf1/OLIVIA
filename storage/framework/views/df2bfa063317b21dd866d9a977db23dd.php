...
<head>
    ...
    <title>Chat — <?php echo e($report->category); ?> · Safora</title>
...
<body class="bg-[#faf9f7] text-gray-900 antialiased">
    ...
    <nav class="bg-white border-b border-gray-200 flex-shrink-0 z-50 relative">
        <div class="absolute left-6 top-1/2 -translate-y-1/2 z-10">
            <a href="/tracking/<?php echo e($report->id); ?><?php echo e(($userLat && $userLng) ? '?lat=' . $userLat . '&lng=' . $userLng : ''); ?>" class="flex items-center gap-1.5 text-gray-500 hover:text-gray-900 transition text-sm font-semibold">
        ...
        <div class="max-w-2xl mx-auto pl-24 pr-4 md:px-4 h-14 flex items-center justify-between gap-3">
            <div class="flex-1 min-w-0">
                <p class="font-bold text-gray-900 text-sm truncate">
                    ...
                    <span class="text-gray-400 font-normal">· #<?php echo e(strtoupper(substr($report->id, 0, 8))); ?></span>
                </p>
                <p class="text-xs text-gray-400"><?php echo e($report->created_at->format('d M Y, H:i')); ?>

                    <?php if($report->latitude && $report->longitude): ?>
                        ·
                        <a href="https://maps.google.com/?q=<?php echo e($report->latitude); ?>,<?php echo e($report->longitude); ?>" target="_blank" class="text-red-600 hover:underline">📍 Lokasi</a>
                    <?php endif; ?>
                </p>
            </div>
            <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg font-semibold flex-shrink-0"><?php echo e($currentName); ?></span>
        </div>
    </nav>
    ...
    <div id="chat-wrapper">
        ...
        <div class="bg-white border-t border-gray-200 px-4 py-3 flex-shrink-0">
            ...
            <p class="text-center text-xs text-gray-400 mt-2">Mengirim sebagai <span class="font-semibold"><?php echo e($currentName); ?></span></p>
        </div>
    </div>
...
const userLat  = <?php echo e($userLat !== null ? $userLat : 'null'); ?>;
const userLng  = <?php echo e($userLng !== null ? $userLng : 'null'); ?>;

let serverMessages = [
    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    {
        id: '<?php echo e($msg['id']); ?>',
        message: <?php echo json_encode($msg['message']); ?>,
        sender_name: <?php echo json_encode($msg['sender_name']); ?>,
        time: '<?php echo e($msg['time']); ?>',
        is_mine: <?php echo e($msg['is_mine'] ? 'true' : 'false'); ?>,
        status: 'sent'
    },
...
async function sendMsg() {
    ...
    const pendingMsg = {
        id: 'temp-' + Date.now(),
        message: msg,
        sender_name: '<?php echo e($currentName); ?>',
        time: `${hh}:${mm}`,
        is_mine: true,
        status: 'pending'
    };
...
<?php /**PATH D:\CODING\olivia_final\resources\views/pages/chat.blade.php ENDPATH**/ ?>