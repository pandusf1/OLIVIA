...
<p class="text-gray-900 font-bold text-xl truncate"><?php echo e($partner->partner_name); ?></p>
                    ...
                    ?>
                    <p class="text-gray-500 text-sm mt-1"><?php echo e($typeLabel); ?></p>
                </div>
            </div>
        </div>
                ...
                <div class="grid lg:grid-cols-12 gap-6 items-start">
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <div class="relative">
                            ...
                            <?php if($hasLatLng): ?>
                                <div class="mt-3">
                                    <a href="https://www.openstreetmap.org/?mlat=<?php echo e($partner->latitude); ?>&mlon=<?php echo e($partner->longitude); ?>#map=16/<?php echo e($partner->latitude); ?>/<?php echo e($partner->longitude); ?>" target="_blank" class="inline-flex items-center gap-2 text-sm font-semibold text-red-700 hover:text-red-800 transition underline">
                                        <span>📍</span>
...
<?php if($hasLatLng): ?>
(function () {
    const lat = <?php echo json_encode((float) $partner->latitude, 15, 512) ?>;
    const lng = <?php echo json_encode((float) $partner->longitude, 15, 512) ?>;
