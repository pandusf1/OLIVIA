                ...
                <div class="px-4 py-3 border-b border-gray-100 flex items-center gap-3 justify-between">
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                        <div id="mitra-avatar-wrap">
                            <?php if(!empty($mitra->image_url ?? null)): ?>
                                <img id="mitra-avatar" src="<?php echo e($mitra->image_url); ?>" class="w-9 h-9 rounded-xl object-cover border border-gray-100" alt="">
                            <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <p id="mitra-name" class="font-bold text-gray-900 text-sm truncate"><?php echo e($viewerType === 'mitra' ? (($reportContext?->anonymous ?? false) ? 'Anonim' : ($reportContext?->user?->name ?? (($thread ?? null) && $thread->user ? $thread->user->name : 'Pelapor'))) : ($mitra->mitra_name ?? 'Pilih mitra')); ?></p>
                            <?php
                                $headerType = '';
                                if ($viewerType === 'mitra') {
                                    $headerType = 'Pelapor';
                            ...
                            ?>
                            <p id="mitra-type" class="text-xs text-gray-400"><?php echo e($headerType); ?></p>
                        </div>
                    </div>
...
<script>
    let currentMitraId = <?php echo json_encode($mitraId); ?>;
