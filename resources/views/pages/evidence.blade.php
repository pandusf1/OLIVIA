            ...
            <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                ...
                <div class="divide-y divide-gray-50">
                    ...
                    <div class="flex items-center justify-between px-5 py-3">
                        ...
                        <a href="{{ str_starts_with($ev->file_url, 'data:') ? $ev->file_url : url('/evidences/view/' . basename($ev->file_url)) }}" target="_blank" class="text-red-700 hover:text-red-800 text-xs font-semibold transition">Buka →</a>
                    </div>
                    @endforeach
                </div>
            </div>
