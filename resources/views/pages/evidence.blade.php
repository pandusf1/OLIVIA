...
<head>
    ...
    <title>SuraRa — Evidence Locker</title>
...
<body class="bg-[#faf9f7] text-gray-900 antialiased min-h-screen">
    ...
    <div class="max-w-3xl mx-auto px-6 py-10">
        <div class="mb-8">
            <p class="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-1">EVIDENCE LOCKER</p>
            <h1 class="font-unbounded text-3xl font-black text-gray-900">Bukti tersimpan aman.</h1>
