...
<body class="bg-[#faf9f7] text-gray-900 antialiased min-h-screen">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
        <div class="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
            ...
            <form action="{{ route('profile.phone.resend') }}" method="POST" class="mt-3 js-resend-form">
                @csrf
                <button type="submit" data-resend-button data-initial-seconds="{{ (int) $phoneResendSeconds }}" class="w-full border border-gray-200 hover:bg-gray-50 text-gray-700 py-3 rounded-xl font-semibold text-sm transition disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400 disabled:hover:bg-gray-100 flex items-center justify-center gap-2">
