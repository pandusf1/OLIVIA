...
<head>
    ...
    <title>SuraRa — Edit Trusted Contact</title>
...
<body class="bg-[#faf9f7] text-gray-900 antialiased min-h-screen">
    ...
    <div class="max-w-lg mx-auto px-6 py-10">
        <div class="mb-8">
            ...
            <h1 class="font-unbounded text-3xl font-black text-gray-900">Edit Kontak Terpercaya</h1>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6 mb-6">
            <h2 class="font-bold text-gray-900 mb-4">Form Edit</h2>
            ...
            <form action="{{ route('trusted-contact.update', $contact->id) }}" method="POST" class="space-y-3">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('trusted-contact.index') }}" class="flex-1 text-center border border-gray-200 hover:bg-gray-50 text-gray-800 py-3 rounded-xl font-bold text-sm transition">Batal</a>
                    <button class="flex-1 bg-gray-900 hover:bg-gray-700 text-white py-3 rounded-xl font-bold text-sm transition">Simpan</button>
                </div>
            </form>
        </div>
